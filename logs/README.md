...
| [2026-09-17](SessionLog_2026-09-17_Supercontinuum-Source.md) | Supercontinuum source mode on the laser | Band on a nominal spacing, power per nm; one beam per sample; fibre and caustic taught about samples. |
...
| [2026-09-17_supercontinuum-prism.png](2026-09-17_supercontinuum-prism.png) | A 400–700 nm supercontinuum (13 samples on 25 nm) fanned out by the PS850, 556 nm on the grating below; the laser's exit arrow drawn as a spectrum. |
